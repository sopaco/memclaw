...
> How to keep this knowledge base accurate and useful. Last updated: 2025-01-11.
...
### For DECISIONS.md
- Format: `## Decision: [Title]` followed by Context, Options, Choice, Rationale
...
- Format: `## [Status]: [Issue]` where Status = Active / Resolved / Monitoring
...
| Script | Purpose |
|--------|---------|
| `check-drift.ts` | Compare documented components against actual directory structure |
| `list-decisions.ts` | Extract decision titles from DECISIONS.md for quick reference |
| `audit-dynamics.ts` | Check for stale issues (>30 days without update) |

### When to Create Scripts

If you find yourself repeating a maintenance task:
1. Consider if a script would help
2. If yes, create it in `meta/scripts/`
...
- [ ] Can someone new to the project understand PROJECT-ESSENCE.md in 2 minutes?
...
| Date | Change |
|------|--------|
| 2025-01-11 | Initial maintenance guide created |
